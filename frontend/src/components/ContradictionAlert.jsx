          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-2">
              <div className="flex flex-col bg-neutral-950/60 border border-white/5 rounded-xl p-3">
                <div className="text-[10px] font-bold text-sky-400 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                  <span>🎙️</span> Management Statement (Audio)
                </div>
              ...
              <div className="flex flex-col bg-neutral-950/60 border border-white/5 rounded-xl p-3">
                <div className="text-[10px] font-bold text-violet-400 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                  <span>📄</span> SEC Filing (Document)
                </div>
                <p className="text-xs text-neutral-300 leading-relaxed italic">
                  "{c.document_claim}"
                </p>
